...
function ExpenseCategoryEdit() {
    ...
    const fetchCategory = useCallback(async () => {
        try {
            ...
            const response = await fetch(`${config.host}/api/categories/${id}?type=expense`, {
                method: "GET",
                headers: {
                    "x-auth-token": token
                }
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            navigate("/expense"); // redirecting to expense categories page
        } catch (error) {
    ...
    return (
        <div className="container my-5">
            <h1 className="main-page-title">Edit Expense Category</h1>
